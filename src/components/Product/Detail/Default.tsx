                  ...
                  <div className="main-content lg:pt-8 pt-6 lg:pb-6 pb-4 sm:px-4 px-3 border border-line rounded-xl relative max-md:w-2/3 max-sm:w-full">
                    ...
                    <div className="list grid grid-cols-6">
                      <div className="item flex items-center justify-center lg:px-3 px-1">
                        <Image
                          src={
                            "https://anvogue.vercel.app/_next/image?url=%2Fimages%2Fpayment%2FFrame-0.png&w=1080&q=75"
                          }
                          width={500}
                          height={450}
                          alt="payment"
                      ...
                      <div className="item flex items-center justify-center lg:px-3 px-1">
                        <Image
                          src={
                            "https://anvogue.vercel.app/_next/image?url=%2Fimages%2Fpayment%2FFrame-1.png&w=1080&q=75"
                          }
                          width={500}
                          height={450}
                          alt="payment"
                      ...
                      <div className="item flex items-center justify-center lg:px-3 px-1">
                        <Image
                          src={
                            "https://anvogue.vercel.app/_next/image?url=%2Fimages%2Fpayment%2FFrame-2.png&w=1080&q=75"
                          }
                          width={500}
                          height={450}
                          alt="payment"
                      ...
                      <div className="item flex items-center justify-center lg:px-3 px-1">
                        <Image
                          src={
                            "https://anvogue.vercel.app/_next/image?url=%2Fimages%2Fpayment%2FFrame-3.png&w=1080&q=75"
                          }
                          width={500}
                          height={450}
                          alt="payment"
                      ...
                      <div className="https://anvogue.vercel.app/_next/image?url=%2Fimages%2Fpayment%2FFrame-4.png&w=1080&q=75">
                        <Image
                      ...
                      <div className="item flex items-center justify-center lg:px-3 px-1">
                        <Image
                          src={
                            "https://anvogue.vercel.app/_next/image?url=%2Fimages%2Fpayment%2FFrame-5.png&w=1080&q=75"
                          }
                          width={500}
                          height={450}
                          alt="payment"
